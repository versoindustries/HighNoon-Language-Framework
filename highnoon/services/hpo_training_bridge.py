...
class HPOTrainingConfig:
    ...
    def from_hpo_sweep(
        ...
        # Training loop flags
        for key in [
            "use_tensor_galore", "galore_rank", "galore_scale",
            "use_quantum_natural_gradient", "qng_damping",
            "barren_plateau_monitor", "barren_plateau_threshold",
            "use_meta_controller", "meta_controller_frequency",
            "use_quantum_lr_controller",
            "use_entropy_regularization", "entropy_reg_weight",
            "use_qhpm_crystallization", "qhpm_crystallization_threshold",
            "use_sympflow_optimizer",
            "use_neural_zne", "use_neural_qem",
        ]:
            if key in best_hp:
        ...
        quantum_flags = [
            "use_quantum_embedding", "use_floquet_position",
            "use_quantum_feature_maps", "use_unitary_expert",
            "use_quantum_norm", "use_superposition_bpe",
            "use_grover_qsg", "use_quantum_lm_head",
            "use_unitary_residual", "use_quantum_state_bus",
            "use_quantum_measurement_dropout", "use_q_ssm_gating",
            "use_qasa_attention", "use_mpqr_reasoning",
            "use_td_moe", "use_vqem", "use_qcot_reasoning",
        ]
